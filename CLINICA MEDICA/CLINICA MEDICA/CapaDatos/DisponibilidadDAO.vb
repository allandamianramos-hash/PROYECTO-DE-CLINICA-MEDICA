    ...
    Public Sub Guardar(disponibilidad As Disponibilidad)
        ...
        Try
            Using conexion As New NpgsqlConnection(cadenaConexion)
                ...
                Dim consulta As String = "
                    CALL registrar_disponibilidad_medico(
                        @id_medico,
                        @hora_inicio,
                        @hora_fin
                    );
        ...
        Catch ex As Exception
            MessageBox.Show("Error al guardar disponibilidad: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Public Sub Editar(disponibilidad As Disponibilidad)
        ...
        Try
            Using conexion As New NpgsqlConnection(cadenaConexion)
                ...
                Dim consulta As String = "
                    CALL actualizar_disponibilidad_medico(
                        @id_disponibilidad,
                        @id_medico,
                        @hora_inicio,
                        @hora_fin
        ...
        Catch ex As Exception
            MessageBox.Show("Error al editar disponibilidad: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Public Sub Eliminar(idDisponibilidad As Integer)
        ...
        Try
            Using conexion As New NpgsqlConnection(cadenaConexion)
                ...
                Dim consulta As String = "
                    CALL eliminar_disponibilidad_medico(@id_disponibilidad);
                "
        ...
        Catch ex As Exception
            MessageBox.Show("Error al eliminar disponibilidad: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
